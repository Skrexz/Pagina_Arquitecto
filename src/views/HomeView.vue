...
const phrasesArray = [
  `En los momentos de desafío, descubrimos nuestra verdadera fortaleza. Cada obstáculo es una oportunidad disfrazada,
   una invitación a crecer y a descubrir la resistencia que yace en nuestro interior.`,

  `Las adversidades son simplemente trampolines para alcanzar alturas que nunca hubiéramos imaginado. Recuerda,
    no es la magnitud de la caída, sino la fuerza con la que te levantas lo que define tu camino.`,

  `Cada experiencia, ya sea un tropiezo o un logro, es una lección valiosa que te acerca un paso más a la mejor versión de ti mismo. No temas a los desafíos, abrázalos con valentía,
    porque en la lucha y la superación descubrimos la verdadera medida de nuestra grandeza.`,
];
